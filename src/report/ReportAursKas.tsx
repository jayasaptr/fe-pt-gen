...
const ReportArusKas = () => {
    ...
    const columns: column[] = React.useMemo(
        () => [
            ...
            },
            {
                ...
                enableSorting: true,
                cell: ({ row }: { row: any }) => {
                    const value = row.getValue("total_sales");
            ...
            },
            {
                ...
                enableSorting: true,
                cell: ({ row }: { row: any }) => {
                    const value = row.getValue("total_purchase");
                    return `Rp ${Number(value).toLocaleString("id-ID")}`;
                }
            },
        ],
    ...
    const fetchDataBarangMasuk = async () => {
        setLoadingV(true);
        try {
            const userResponse = await axiosInstance.get("/kas", {
                headers: {
    ...
    return (
        <>
            ...
            <div style={{ display: "none" }}>
                <ReportPrint ref={printRef} title="Report Arus Kas">
                    <TableContainer
                        isPagination={false}
                        isTfoot={false}
                        isSelect={false}
